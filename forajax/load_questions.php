            ...
            <tr>
                ...
                <?php
                    if(strpos($opt1,'images/')!=false){
                        ?>
                        <img src="admin/<?php echo $opt1; ?>" height="40" width="40">
                        <?php
                    }
                    else{
                        echo $opt1;
            ...
            <tr>
                ...
                <?php
                    if(strpos($opt2,'images/')!=false){
                        ?>
                        <img src="admin/<?php echo $opt2; ?>" height="40" width="40">
                        <?php
                    }
                    else{
                        echo $opt2;
            ...
            <tr>
                ...
                <?php
                    if(strpos($opt3,'images/')!=false){
                        ?>
                        <img src="admin/<?php echo $opt3; ?>" height="40" width="40">
                        <?php
                    }
                    else{
                        echo $opt3;
            ...
            <tr>
                ...
                <?php
                    if(strpos($opt4,'images/')!=false){
                        ?>
                        <img src="admin/<?php echo $opt4; ?>" height="40" width="40">
                        <?php
                    }
                    else{
                        echo $opt4;
