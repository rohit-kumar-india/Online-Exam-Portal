            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><b>Add New Questions with text</b></div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                            <div class="card-header"><b>Add New Questions with images</b></div>
                            <div class="card-body card-block">
                                ...
                                <div class="form-group"><label for="company" class=" form-control-label">Add Opt1</label><input type="file" name="fopt1" style="padding-bottom:36px;" class="form-control"></div>
                                <div class="form-group"><label for="company" class=" form-control-label">Add Opt2</label><input type="file" name="fopt2" style="padding-bottom:36px;" class="form-control"></div>
                                <div class="form-group"><label for="company" class=" form-control-label">Add Opt3</label><input type="file" name="fopt3" style="padding-bottom:36px;" class="form-control"></div>
                                <div class="form-group"><label for="company" class=" form-control-label">Add Opt4</label><input type="file" name="fopt4" style="padding-bottom:36px;" class="form-control"></div>
                                <div class="form-group"><label for="company" class=" form-control-label">Add Answer</label><input type="file" name="fanswer" style="padding-bottom:36px;" class="form-control"></div>
                                    <div class="form-group">
...
<?php
    if(isset($_POST["submit1"]))
    {
        $loop=0;
        $count=0;
        $res=mysqli_query($link,"select * from questions where category='$exam_category'order by id") or die(mysqli_error($link));
