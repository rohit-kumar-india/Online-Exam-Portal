                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card-body card-block">
                                ...
                                <label for="company" class=" form-control-label">Add Opt1</label><input type="file" name="fopt1" style="padding-bottom:36px;" class="form-control"></div>
                                <div class="form-group">
                                    <img src="<?php echo $opt2; ?>" height="50" width="50"> <br>
                                <label for="company" class=" form-control-label">Add Opt2</label><input type="file" name="fopt2" style="padding-bottom:36px;" class="form-control"></div>
                                <div class="form-group">
                                    <img src="<?php echo $opt3; ?>" height="50" width="50"> <br>
                                <label for="company" class=" form-control-label">Add Opt3</label><input type="file" name="fopt3" style="padding-bottom:36px;" class="form-control"></div>
                                <div class="form-group">
                                    <img src="<?php echo $opt4; ?>" height="50" width="50"> <br>
                                <label for="company" class=" form-control-label">Add Opt4</label><input type="file" name="fopt4" style="padding-bottom:36px;" class="form-control"></div>
                                <div class="form-group">
                                  <img src="<?php echo $answer; ?>" height="50" width="50"> <br>
                                <label for="company" class=" form-control-label">Add Answer</label><input type="file" name="fanswer" style="padding-bottom:36px;" class="form-control"></div>
                                    <div class="form-group">
